...
extends ParentNode implements Document  {
     ...
     * 
     * @throws org.w3c.dom.DOMException(INVALID_NAME_ERR)
     ...
     *
     * @throws org.w3c.dom.DOMException(NOT_SUPPORTED_ERR) for HTML documents. (HTML
     * not yet implemented.)
     */
     ...
     *
     * @throws org.w3c.dom.DOMException(INVALID_NAME_ERR) if the tag name is not
     * acceptable.
     */
     ...
     *
     * @throws org.w3c.dom.DOMException(NOT_SUPPORTED_ERR) for HTML documents, where
     ...
     *
     * @throws org.w3c.dom.DOMException(INVALID_NAME_ERR) if the target name is not
     * acceptable.
     *
     * @throws org.w3c.dom.DOMException(NOT_SUPPORTED_ERR) for HTML documents. (HTML
     * not yet implemented.)
     ...
     * @throws org.w3c.dom.DOMException NAMESPACE_ERR: Raised if the qualifiedName has a
     ...
     *
     * @return Element A new Element object with the following attributes:
     * @exception org.w3c.dom.DOMException INVALID_CHARACTER_ERR: Raised if the specified
     *                   name contains an invalid character.
     */
    public Element createElementNS(String namespaceURI, String qualifiedName,
    String localpart)
