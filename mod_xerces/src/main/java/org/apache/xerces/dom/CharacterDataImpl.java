...
public abstract class CharacterDataImpl
   ...
   /** Convenience wrapper for calling setNodeValueInternal when 
     ...
     * 
     * @throws org.w3c.dom.DOMException(NO_MODIFICATION_ALLOWED_ERR) if node is readonly.
     */
     ...
     * 
     * @throws org.w3c.dom.DOMException(INDEX_SIZE_ERR) if offset is negative or
     * greater than length, or if count is negative.
     * 
     * @throws org.w3c.dom.DOMException(NO_MODIFICATION_ALLOWED_ERR) if node is
     * readonly.  
     */
     ...
     * greater than length, or if count is negative.
     *
     * @throws org.w3c.dom.DOMException(WSTRING_SIZE_ERR) In some implementations,
